...
class BaseModel():
    ...
    Methods:
        save: updates the `updated_at` instance attribute with the current datetime
        to_dict: returns a dictionary containing all keys/values of the __dict__
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (numberOfItemsInKwargs == 0):
            ...
            # If kwargs are used, modify the attributes to suit instantiation
            kwargs = to_instantiable_attributes(**kwargs)
            # Initialize instance with the modified attributes in kwargs
            for attribute, value in kwargs.items():
                # Add the attributes and their values to the __dict__ attribute of the instance
                # here by instantiating it
                self.__dict__[attribute] = value


    def __str__(self):
        ''' Displays a human-readable string representation of the BaseModel instance '''
    ...
    def to_dict(self):
        ...
        # Add a __class__ attribute to the instance attributes, with the class name as it's value
