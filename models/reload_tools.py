...
Functions:
    modifyKwargsForInstantiation: takes the attributes and suit
...
def modifyKwargsForInstantiation(**kwargs):
    '''Modifies the keyword arguments to be able to create
    an instance with them Returns the modified keyword arguments
    '''
    # STEP 1: Removes the "__class__" attribute
    if "__class__" in kwargs.keys():
        kwargs.pop("__class__")
    # STEP 2: Changes the "created_at" attribute from
    # a string format to a datetime format
    if "created_at" in kwargs.keys():
        # Error handling in case the format is already changed to a
        # datetime format before calling this function
    ...
    # STEP 3: Change the "updated_at" attribute from string
